...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Rehan Khan  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Rehankhan ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")

ua = requests.get('https://raw.githubusercontent.com/Rehankhano/premium/main/data/useragent.txt').text.strip()
ua2 = requests.get('https://raw.githubusercontent.com/Rehankhano/premium/main/data/useragent2.txt').text.strip()
